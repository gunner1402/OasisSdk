...
public class MsgListView extends ListView implements OnScrollListener {
	 ...
	 private void init(Context context) {
	  ...
	  headView = (LinearLayout) inflater.inflate(BaseUtils.getResourceValue("layout", "oasisgames_sdk_common_listview_head"), null);//listview拼接headview

	  arrowImageView = (ImageView) headView
	    .findViewById(BaseUtils.getResourceValue("id", "oasisgames_sdk_common_listview_head_arrowImageView"));//headview中各view
	  arrowImageView.setMinimumWidth(50);
	  arrowImageView.setMinimumHeight(50);
	  progressBar = (ProgressBar) headView
	    .findViewById(BaseUtils.getResourceValue("id", "oasisgames_sdk_common_listview_head_progressBar"));//headview中各view
	  tipsTextview = (TextView) headView.findViewById(BaseUtils.getResourceValue("id", "oasisgames_sdk_common_listview_head_tipsTextView"));//headview中各view
	  lastUpdatedTextView = (TextView) headView
	    .findViewById(BaseUtils.getResourceValue("id", "oasisgames_sdk_common_listview_head_lastUpdatedTextView"));//headview中各view
...
//	     .setImageResource(R.drawable.ic_pulltorefresh_arrow);
	 ...
	 public void onRefreshComplete() {
	  state = DONE;
	  lastUpdatedTextView.setText("最近更新:" + new Date().toString());//刷新完成时，头部提醒的刷新日期
	  changeHeaderViewByState();
	 }
